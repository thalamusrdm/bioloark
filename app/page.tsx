...
const pathways = [
  { number: '01', label: 'READY-MADE', title: 'יצירות מוכנות', description: 'טרריומים מעוצבים וקומפוזיציות בוטניות חד־פעמיות, מוכנים להכניס עולם חי לחלל.', image: '/images/path-ready-made.webp', href: '/category/טרריומים-מעוצבים' },
