...
export default async function Home() {
  ...
  return <main className="home-boutique"><ScrollMotion /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(organization) }} />
    <section className="hero" id="top"><div className="hero-image" data-scroll-media data-scroll-speed="12" aria-hidden="true" /><div className="hero-veil" aria-hidden="true" /><div className="hero-content" data-reveal><p className="eyebrow">BOTANICAL ART DESIGN FOR INTERIORS</p><h1><span className="hero-brand-line" dir="ltr">Bioloark</span><span className="hero-tagline">עיצוב חי, מדויק<br />ומלא השראה</span></h1><p className="hero-copy">אנחנו משלבים בין עיצוב, איזון ותשומת לב לפרטים כדי ליצור מראה נקי, מרשים ומלא השראה</p><a className="primary-button" href="#collection">למוצרי החנות <span>←</span></a></div></section>
