...
export default async function Home() {
  ...
  return <main><ScrollMotion /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(organization) }} />
    <section className="hero" id="top"><div className="hero-image" data-scroll-media data-scroll-speed="28" aria-hidden="true" /><div className="hero-veil" aria-hidden="true" /><div className="hero-content" data-reveal><p className="eyebrow">BOTANICAL ART DESIGN FOR INTERIORS</p><h1><span className="hero-brand-line" dir="ltr">Bioloark</span><span className="hero-tagline">עולמות קטנים שמכניסים חיים לכל חלל</span></h1><p className="hero-copy">אנחנו משלבים בין עיצוב, איזון ותשומת לב לפרטים כדי ליצור מראה נקי, מרשים ומלא השראה</p><a className="primary-button" href="#collection">למוצרי החנות <span>←</span></a></div><div className="hero-note"><span>01</span><p>עיצוב בוטני בהשראת מסורת הזן היפנית</p></div></section>
    ...
    <section className="terrarium-feature"><img src="/images/terrarium-feature.webp" alt="טרריום מעוצב של Bioloark" data-scroll-media data-scroll-speed="18" data-scroll-zoom="0.045" /><div className="terrarium-feature-copy" data-reveal><p className="eyebrow">A WORLD WITHIN</p><h2>טבע חי.<br />בתוך עולם משל עצמו.</h2><p>קומפוזיציות בוטניות חד־פעמיות, שנבנות שכבה אחר שכבה וממשיכות להשתנות יחד עם החלל.</p><a className="outline-button" href="/category/טרריומים-מעוצבים">לחנות טרריומים מעוצבים</a></div></section>
    ...
    <section className="about-section" id="about"><div className="about-image"><img src="/images/about-care.jpg" alt="ידיים מטפלות בעדינות בנבט צעיר" loading="lazy" data-scroll-media data-scroll-speed="20" /></div><div className="about-copy" data-reveal><p className="eyebrow dark">קצת עלינו</p><h2>כמו בטבע, ביולארק נולדה מתוך אהבה!</h2><p className="about-lead">אנחנו מתמחים ביצירת טרריומים מעוצבים, מערכות צמחייה מתקדמות וקירות ירוקים, המכניסים שלווה, יוקרה וירוק חי אל בתים, משרדים ומלונות.</p><p>כל פרויקט אצלנו מתוכנן בקפדנות – מאפיון החלל, בחירת הצמחים המתאימים ועד תחזוקה קלה לאורך זמן. המטרה שלנו היא ליצור עבורכם פינה ירוקה ייחודית, מותאמת אישית, שנראית כמו יצירת אמנות חיה ונשארת יפה לאורך שנים.</p><a href="/project-showcase">לפרויקטים שלנו <span>←</span></a></div></section>
