  ...
  return (
    <div className="drawer-layer" role="dialog" aria-modal="true" aria-label="סל קניות">
      ...
      <aside className="cart-drawer">
        ...
        {!shopifyEnabled ? <div className="preview-cart"><span>Preview</span><h3>החנות כמעט מוכנה</h3><p>המוצרים מוצגים כרגע מתוכן האתר הישן. רכישה תופעל אוטומטית לאחר חיבור חנות Shopify.</p><a href="mailto:info@bioloark.co.il">לבירור והזמנה במייל</a></div> : cart?.lines.length ? <>
          ...
          <div className="cart-summary"><div><span>סכום ביניים</span><strong>{shekels(cart.subtotal.amount, cart.subtotal.currencyCode)}</strong></div><p>משלוח ומסים יחושבו בשלב התשלום.</p><a className="checkout-button" href={cart.checkoutUrl}>לתשלום מאובטח ב־Shopify</a></div>
