  ...
  return (
    <footer className="site-footer">
      <div className="footer-main">
        ...
        <div><h3>גלו</h3><a href="/category/all-products">כל המוצרים</a><a href="/category/rare-plants">צמחים</a><a href="/category/כלים-להכנה">הכל לטרריום</a><a href="/workshops">סדנאות</a><a href="/project-showcase">פרויקטים</a></div>
